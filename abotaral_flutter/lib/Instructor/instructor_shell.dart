...
import '../../core/instructor_widgets/bottom_nav_bar.dart';
...
final GlobalKey<InstructorShellState> instructorShellKey =
    GlobalKey<InstructorShellState>();

class InstructorShell extends StatefulWidget {
  const InstructorShell({super.key});

  @override
  State<InstructorShell> createState() => InstructorShellState();
}

class InstructorShellState extends State<InstructorShell> {
  int _currentIndex = 0;
